...
\section{Discussion}
  ...
  \subsection{Compositionality and player skills}

  \subsection{Abstraction boundaries between input and mechanics}

  XXX the tools to try on different interfaces to the same mechanics

  \subsection{Scripting languages for free}


  \subsection{Co-creative interfaces and collaborative play}
