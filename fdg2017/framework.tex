  ...
  \begin{figure*}
    \begin{tabular}{cc}
    \includegraphics[height=0.25\textheight]{../uis/point-and-click.png}
    \includegraphics[height=0.25\textheight]{../uis/bev-color.png}
    \\
    \includegraphics[height=0.25\textheight]{../uis/parser.png}
    \includegraphics[height=0.25\textheight]{../uis/hypertext.png}
  \end{tabular}
  \end{figure*}
